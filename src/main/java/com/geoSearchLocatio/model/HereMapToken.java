...
public class HereMapToken {
	 private String consumerKey;
	    ...
	    public HereMapToken(String consumerKey, String consumerSecret, String token, String tokenSecret) {
...
//	        String nonce ="oWqla4Nb1ew";
//			
//	        	String timestamp = "1642906330";
...
//	        append(base, oauth_token, token);
	    ...
	    private String generateSignatureBaseString(String httpMethod, String url, Map<String, String> requestParams, String nonce, String timestamp) {
	        ...
	        put(params, "grant_type", "client_credentials");
	        put(params, "oauth_consumer_key", "55kZw_geYw9ApgbBrs-_cw");
	        put(params, "oauth_nonce", nonce);
	        put(params, "oauth_signature_method", "HMAC-SHA1");
